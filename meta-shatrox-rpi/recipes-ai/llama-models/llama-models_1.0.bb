...
SRC_URI = "https://huggingface.co/bartowski/Qwen2.5-1.5B-Instruct-GGUF/resolve/main/Qwen2.5-1.5B-Instruct-Q4_K_M.gguf;name=qwen15b_q4km \
           https://huggingface.co/bartowski/Qwen2.5-1.5B-Instruct-GGUF/resolve/main/Qwen2.5-1.5B-Instruct-Q4_K_S.gguf;name=qwen15b_q4ks \
...
SRC_URI[qwen15b_q4ks.sha256sum] = "cd382e90a417faa648ea012ebae8b97f94b3836be02947b0522886339ad1e1d7"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/Qwen2.5-1.5B-Instruct-Q4_K_S.gguf \
        ${D}${datadir}/llama-models/
    ...
    # Default: Q4_K_S (medium) - best speed/quality balance
    ln -sf Qwen2.5-1.5B-Instruct-Q4_K_S.gguf \
